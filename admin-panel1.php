...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="" aria-hidden="true"></i><h2>BlackBirdS</h2></a>
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="" id="list-ddoc-list"  role="tab" data-toggle="list" aria-controls="home">Billing</a>
               ...
               <div class="col-sm-4">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body border">
                      <span class="fa-stack fa-2x"> <i class="text-primary"></i> <i class="fa fa-users fa-stack-1x fa-inverse"></i> </span>
                ...
                <div class="col-sm-4" style="left: 18%;margin-top: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body border" >
                      <span class="fa-stack fa-2x"> <i class="text-primary"></i> <i class="fa fa-plus fa-stack-1x fa-inverse"></i> </span>
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          <div class="row">
                  ...
                  <div class="col-md-4"><label>Depertment:</label></div>
                  <div class="col-md-8">
                   <select name="special" class="form-control" id="special" required="required">
                      <option value="head" name="spec" disabled selected>Select Depertment</option>
                  ...
                  <div class="col-md-4"><label>Doctor Fees:</label></div>
