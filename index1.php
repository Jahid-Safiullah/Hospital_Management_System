...
.btn-primary{
  ...
  <body style="background: -webkit-linear-gradient(left, #429993, #429993); background-size: cover;">
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">

      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h2><i class="" aria-hidden="true"></i>BlackBirdS</h2></a>
    ...
    <div class="container-fluid" style="margin-top:60px;margin-bottom:60px;color:#34495E;">
      <div class="row">
         ...
         <div class="col-md-5" style="margin-top: 5%;right: 8%">
