...
function checklen()
{
    ...
    if(pass1.value.length<3){  
        alert("Password must be at least 3 characters long. Try again!");  
        return false;  
  }  
}
</script>
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h2><i class="" aria-hidden="true"></i>&nbsp BlackBirdS</h2></a>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-2 register-left" style="margin-top: 10%;right: 5%">
                        <!-- <img src="https://image.ibb.co/n7oTvU/logo_white.png" alt=""/> -->
                        <!-- <h3>Welcome</h3> -->
                       
                    </div>
                    <div class="col-md-8 register-right" style="margin-top: 40px;left: 0px;">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <h3 class="register-heading">Registration as Patient</h3>
