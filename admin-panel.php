...
include('func.php');  
include('newfunc.php');
$con=mysqli_connect("jahangiralam.online","jahangir","jahangir_idb@wdpf","jahangir_crud");
...
function generate_bill(){
  ...
  $pid = $_SESSION['pid'];
  $output='';
  $query=mysqli_query($con,"select p.pid,p.ID,p.fname,p.lname,p.doctor,p.appdate,p.apptime,p.disease,p.prescription,a.docFees from prestb p inner join appointmenttb a on p.ID=a.ID and p.pid = '$pid' and p.ID = '".$_GET['ID']."'");
...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h1 align ="center"> BlackBirdS</h1></br>
      <h3 align ="center"> Bill History</h3>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="" aria-hidden="true"></i> BlackBirdS </a>
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(left, #429993, #429993);
}
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" id="list-home-list" data-toggle="list" href="#list-home" role="tab" aria-controls="home">Booking Appointment</a>
               ...
               <div class="col-sm-4" style="left: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body border">
                      <span class="fa-stack fa-2x"> <i class="text-primary"></i> <i class="fa fa-terminal fa-stack-1x fa-inverse"></i> </span>
                ...
                <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body border" >
                      <span class="fa-stack fa-2x"> <i class="text-primary"></i> <i class="fa fa-paperclip fa-stack-1x fa-inverse"></i> </span>
                ...
                <div class="col-sm-4" style="left: 20%;margin-top:5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body border" >
                      <span class="fa-stack fa-2x"> <i class="text-primary"></i> <i class="fa fa-list-ul fa-stack-1x fa-inverse"></i> </span>
            ...
            <div class="card-body">
              ...
              <form class="form-group" method="post" action="admin-panel.php">
                <div class="row">
                  ...
                  ?> -->
                    ...
                    <div class="col-md-4">
                          <label for="spec">Depertment:</label>
                        </div>
                        <div class="col-md-8">
              ...
              document.getElementById('spec').onchange = function updateSpecs(e) {
                ...
                document.getElementById('doctor1').value = document.querySelector(`[value=${values}]`).getAttribute('data-value');
                  ...
                  <div class="col-md-4"><label for="doctorfees">
                                Doctor Fees
                              </label></div>
                              <div class="col-md-8">
...
$con=mysqli_connect("jahangiralam.online","jahangir","jahangir_idb@wdpf","jahangir_crud");
                    ...
                    $query = "select doctor,ID,appdate,apptime,disease,prescription from prestb where pid='$pid';";
