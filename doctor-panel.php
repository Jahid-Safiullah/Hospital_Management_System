               ...
               <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body border">
                      <span class="fa-stack fa-2x"> <i class="text-primary"></i> <i class="fa fa-list fa-stack-1x fa-inverse"></i> </span>
...
$con=mysqli_connect("jahangiralam.online","jahangir","jahangir_idb@wdpf","jahangir_crud");
                    ...
                    $query = "select pid,fname,lname,ID,appdate,apptime,disease,prescription from prestb where doctor='$doctor';";
